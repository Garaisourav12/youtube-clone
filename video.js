...
const apiKey = "AIzaSyD844UJTeuqWkFc75khF0ld-IYWWK0EYRo"; //api 1
// const apiKey = "AIzaSyCV6iXeCjT8RxwEAH7YXyFkxddXIVr7wH8";


// some usefull buttons var
...
// all functions fom dom manipulation with the data we have got from api calls
...
// all api calls for getting the all requered details for the selected video
// only differences are in end point and in params and accessing the requered data 
...
// some function to format data from given to more readable format
...
// play the selected video by YT.Player
try{
    playVideo();
}catch(error){
...
// render all details of the selected video
randerData();
...
// function to play the selected video by YT.Player
function playVideo(){
    if(YT){
